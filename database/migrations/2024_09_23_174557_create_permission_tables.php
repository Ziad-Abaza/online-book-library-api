...
return new class extends Migration
{
    public function up(): void
    {
        ...
        // التحقق من تحميل إعدادات الجداول
        if (empty($tableNames)) {
            throw new \Exception('Error: config/permission.php not loaded. Run [php artisan config:clear] and try again.');
        }

        // التحقق من إعدادات الفريق
        ...
        // إنشاء جدول علاقة الصلاحيات بالنماذج
        ...
        // إنشاء جدول علاقة الأدوار بالنماذج
        ...
        // إنشاء جدول علاقة الصلاحيات بالأدوار
